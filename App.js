...
<Modal isVisible={isModalVisible}>
        <View style={{ flex: 1  , backgroundColor: "white" , borderRadius:70 , color:"green" , padding:20 }}>
          <Text>{Responsname}</Text>
          <Text style={{ fontWeight: "bold" , marginVertical: 4, fontSize: 20}}>
         Manufacturer :   {Responsmanufacture}  
          
        </Text>
        <Text style={{ fontWeight: "bold" ,marginVertical: 4, fontSize: 20}}>
         EquipmentNumber:   {Responsnumber}
        </Text>
        <Text style={{fontWeight: "bold" ,marginVertical: 4, fontSize: 20}}>
         EquipmentName :   {Responsname}
        </Text>
        <Text style={{fontWeight: "bold" ,marginVertical: 4, fontSize: 20}}>
         OwnerName:    {Responsowner}
        </Text>
        <Text style={{fontWeight: "bold" ,marginVertical: 4, fontSize: 20}}>
         PreviousOwnerType: {Responspowner}
        </Text>
        <Text style={{ fontWeight: "bold" , fontSize: 20}}>
         CurrentOwnerType: {Responscowner}
        </Text>
        <Text style={{ fontWeight: "bold" ,marginVertical: 4, fontSize: 20}}>
         CreateDateTime:  {Responscdate}
        </Text>
        <Text style={{fontWeight: "bold" ,marginVertical: 4, fontSize: 20}}>
         LastUpdated:  {Responslupdate}
        </Text>
